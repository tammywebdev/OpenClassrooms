...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show active entries*', function () {
			// TODO: write test #2 -- Done.
			var todos = [{ title: 'tomorrow', completed: false }, { title: 'yesterday', completed: true }];
			setUpModel(todos);
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed*', function () {
			// TODO: write test  #6 -- Done
			var todo1 = { id: 21, title: 'my todo', completed: false };
			var todo2 = { id: 22, title: 'my todo 2', completed: false };
			...
			expect(model.update).toHaveBeenCalledWith(22, { completed: true }, jasmine.any(Function));
		});

		it('should update the view*', function () {
			// TODO: write test #7 -- Done
			var todo1 = { id: 21, title: 'my todo', completed: false };
			var todo2 = { id: 22, title: 'my todo 2', completed: false };
			setUpModel([todo1, todo2]);
			subject.setView('');
			...
			expect(view.render).toHaveBeenCalledWith('elementComplete', { id: 22, completed: true });
